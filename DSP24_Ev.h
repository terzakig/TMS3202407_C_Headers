...
//T1CON
struct T1CON_BITS  {
	unsigned int rsvd1:1; // 0 Resrved
	unsigned int TCMPREN:1; // 1 Timer Campare Enables
...
//***********************************************************
// Compare Action Control Registers ACTRA and ACTB
// ACTRA
struct ACTRA_BITS {
	unsigned int  CMP1ACT1:2; // 0-1 Action on Compare Output Pin 1
	unsigned int  CMP2ACT1:2; // 2-3 Action on Compare Output Pin 2
	unsigned int  CMP3ACT1:2; // 4-5 Action on Compare Output Pin 3
	unsigned int  CMP4ACT1:2; // 5-7 Action on Compare Output Pin 4
	unsigned int  CMP5ACT1:2; // 8-9 Action on Compare Output Pin 5
	unsigned int  CMP6ACT1:2; // 10-11 Action on Compare Output Pin 6
...
struct EVAIMRC_BITS {
    unsigned int   CAP1INT:1;     // 0        Enable
    unsigned int   CAP2INT:1;     // 1        Enable
    unsigned int   CAP3INT:1;     // 2        Enable
    unsigned int   rsvd1:13;      // 15:3     reserved
};
...
struct EVAIFRC_BITS {
    unsigned int   CAP1INT:1;     // 0        Flag
    unsigned int   CAP2INT:1;     // 1        Flag
    unsigned int   CAP3INT:1;     // 2        Flag
    unsigned int   rsvd1:13;      // 15:3     reserved
};
